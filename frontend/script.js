...
const API_BASE_URL = window.location.origin === "file://" ? "http://localhost:8000" : ""; // Relative path for deployment, localhost for local file testing
...
function getGreetingResponse() {
  return "Hello! 👋 I am the Odisha Disaster Management Assistant. How can I help you today?";
}
  ...
  req.onsuccess = () => {
    ...
    chatBox.innerHTML = `
      <div class="message ai">
        <div class="bubble">Hello! 👋 I am the Odisha Disaster Management Assistant. How can I help you today?</div>
      </div>`;
    loadChatHistory();
  };
}
